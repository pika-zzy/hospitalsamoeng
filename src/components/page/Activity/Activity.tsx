              ...
              return (
                ...
                >
                  ...
                  <div className={`relative overflow-hidden bg-emerald-50 ${isFeatured ? "h-64" : "h-44"}`}>
                    ...
                    {/* Date badge */}
                    <div className="absolute top-3 left-3 bg-white rounded-2xl px-2.5 py-1.5 flex flex-col items-center shadow-md min-w-[38px]">
            ...
            {activities.length === 1 && (
              <>
                {[1, 2].map((n) => (
                  <div
                    key={`placeholder-${n}`}
                    className="hidden lg:flex flex-col items-center justify-center bg-gray-50/80 rounded-3xl border border-dashed border-gray-200 min-h-[280px] gap-3"
                  >
